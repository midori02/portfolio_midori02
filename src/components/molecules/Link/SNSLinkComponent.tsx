...
const SNSLinkComponent: FC = () => {
  ...
  return (
    <div className={styles.link_component__sns}>
      <IconArea onClick={() => router.push('')} path={'/github_black.png'} width={40} height={40} />
      <IconArea onClick={() => router.push('')} path={'/facebook_black.png'} width={40} height={40} />
      <IconArea onClick={() => router.push('')} path={'/twitter_black.png'} width={40} height={40} />
    </div>
  )
}
